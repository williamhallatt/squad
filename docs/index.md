...
| [Config Reference](reference/config.md) | squad.config.ts, .squad/ structure, models |
| [Scenarios](scenarios/existing-repo.md) | Real-world patterns for your project |
| [What's New](whatsnew.md) | Release history |
